...
EXCLUDED = {
    ...
    # PATCH /dashboard/config/{domain}/settings/{key} came off this list when
    # write_plant_setting landed: one tool for every domain's live settings,
    # gated per key by the owning section's own `define` capability.
